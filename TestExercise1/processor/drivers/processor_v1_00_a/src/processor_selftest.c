/*****************************************************************************
* Filename:          Y:\TDT4255\TestExercise1\processor/drivers/processor_v1_00_a/src/processor_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the processor driver
...
XStatus PROCESSOR_SelfTest(void * baseaddr_p)
{
  ...
  PROCESSOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = PROCESSOR_mReadSlaveReg0(baseaddr, 0);
  ...
  PROCESSOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = PROCESSOR_mReadSlaveReg1(baseaddr, 0);
  ...
  PROCESSOR_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = PROCESSOR_mReadSlaveReg2(baseaddr, 0);
  ...
  PROCESSOR_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = PROCESSOR_mReadSlaveReg3(baseaddr, 0);
  ...
  PROCESSOR_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = PROCESSOR_mReadSlaveReg4(baseaddr, 0);
