/*****************************************************************************
* Filename:          Y:\TDT4255\TestExercise1\MipsCpu/drivers/mipscpu_v1_00_a/src/mipscpu_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the mipscpu driver
...
XStatus MIPSCPU_SelfTest(void * baseaddr_p)
{
  ...
  MIPSCPU_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MIPSCPU_mReadSlaveReg0(baseaddr, 0);
  ...
  MIPSCPU_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MIPSCPU_mReadSlaveReg1(baseaddr, 0);
  ...
  MIPSCPU_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MIPSCPU_mReadSlaveReg2(baseaddr, 0);
  ...
  MIPSCPU_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MIPSCPU_mReadSlaveReg3(baseaddr, 0);
  ...
  MIPSCPU_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = MIPSCPU_mReadSlaveReg4(baseaddr, 0);
